...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Material  Radioativo");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        float mi, mf;
        int t, tm, th, ts;
        mi=Float.valueOf(jTextField1.getText());
        t=0;
        mf=mi;
        while(mf>=0.5){
            mf=mf/2;
        ...
        jTextField3.setText(String.format("%.2f",mf));
        jTextField4.setText("O tempo necessário é " +th +" Horas " +tm +" Minutos e "+ts +" Segundos ");
